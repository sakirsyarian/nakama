...
**Not sent:** HTTP 4xx responses, a turn the user cancelled, and anything a user typed. A rejected request is not a defect, and reporting every bad password would bury the real crashes.
