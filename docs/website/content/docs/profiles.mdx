...
Profile packs exclude plugin assignments and plugin code. After importing a profile, assign the destination organization’s plugin skills and tools manually. See [Plugins](/plugins).
