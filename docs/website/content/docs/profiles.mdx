...
| `artifacts/` | No (dashboard, download API, web chat preview and text edit) | `save-artifact` skill + `write_file` or `write_docx`; org members can also edit text artifacts in the preview panel |
